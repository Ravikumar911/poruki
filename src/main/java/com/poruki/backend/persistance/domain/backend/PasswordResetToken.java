...
import com.poruki.backend.persistance.converters.LocalDateTimeAttributeConverter;
...
public class PasswordResetToken implements Serializable{
	...
	public PasswordResetToken(String token, Users user, LocalDateTime creationDateTime, int expirationInMinutes) {
