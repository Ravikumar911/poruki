...
//			emailService.sendGenericEmailMessage(mailMessage);
	...
	public String changeUserPasswordGet(@RequestParam("id") long id, @RequestParam("token") String token, Locale locale,
		...
		// OK to proceed. We auto-authenticate the user so that in the POST
		// request we can check if the user
		// is authenticated
